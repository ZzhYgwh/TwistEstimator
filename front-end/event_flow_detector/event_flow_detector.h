...
public:
    EventFlowDetector(ros::NodeHandle& nh_this, EventParams& e_params, RadarEventParams r_params, bool show_events, double smooth, int filter_num = 3, bool ignore_polarity = false, double ratio_inliers = 0.1)
...
*/
    ...
    bool Detector() {
...

        {
            ...
            LOG_Velocity(twist_, "/home/hao/Desktop/radar-event-new/src/TwistEstimator/output/detector.tum");
