...
estimator = pd.read_csv('./estimate.tum', header=None, delim_whitespace=True) # estimate.tum ../output/estimate.tum
...
error_norm = np.linalg.norm(estimator_interp_angular_velocity - camera_angular_velocity, axis=1)
