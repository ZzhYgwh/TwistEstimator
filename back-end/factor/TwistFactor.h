...
public:
  ...
  NewDopplerFactor(int64_t time_ns, const Eigen::Vector3d& pt, 
   ...
   virtual bool Evaluate(double const* const* parameters, double* residuals,
    ...
    std::fstream linear_file("/home/hao/Desktop/radar-event-new/src/TwistEstimator/output/linear_res.txt",
  ...
  virtual bool Evaluate(double const* const* parameters, double* residuals,
      ...
      */
      ...
      // LOG(ERROR) << "post_vec = " << post_vec << std::endl;
        ...
        std::fstream angular_file("/home/hao/Desktop/radar-event-new/src/TwistEstimator/output/angular_res.txt",
                                  std::ios::out | std::ios::app);
