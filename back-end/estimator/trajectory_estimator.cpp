...
void TrajectoryEstimator::PrepareMarginalizationInfo(
  ...
  if (options.ctrl_to_be_opt_later > options.ctrl_to_be_opt_now) {
    LOG(ERROR) << "options marginize = [ " << options.ctrl_to_be_opt_now << ", " 
...
void TrajectoryEstimator::AddCallback2(
...
// void TrajectoryEstimator::AddDopplerMeasurementAnalytic(
...
// void TrajectoryEstimator::AddEventFlowMeasurementAnalytic(
//   double timestamp,
...
/*
void TrajectoryEstimator::AddDopplerMeasurementAnalytic2(
...
/*
void TrajectoryEstimator::AddEventFlowMeasurementAnalytic2(
...
// 松耦合
void TrajectoryEstimator::AddBodyLocalVelocityMeasurementAnalytic(
    ...
    bool marg_this_factor)
  {
    ...
    // TODO: EventAgularFactor
    // using Functor = NewEventAgularFactor;
    using Functor = BodyLocalVelocityFactor;
    ceres::CostFunction* cost_function =
    new Functor(time_ns, local_vel, spline_meta, weight, w_weight, R_weight);
...
void TrajectoryEstimator::AddBodyLocalAngularVelocityMeasurementAnalytic(
    ...
    bool marg_this_factor)
  {
    ...
    // TODO: EventAgularFactor
    // using Functor = NewEventAgularFactor;
    using Functor = BodyLocalAngularVelocityFactor;
    ceres::CostFunction* cost_function =
...
void TrajectoryEstimator::AddTwistBiasAnalytic(
